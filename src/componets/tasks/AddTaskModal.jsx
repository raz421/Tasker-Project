...
export default function AddTaskModal({ onAdd, taskToUpdate, onClose }) {
  ...
  const [isTask, setIsTask] = useState(Object.is(taskToUpdate, null));
  return (
    <>
      <div className=" bg-black opacity-50 h-full w-full z-10 absolute top-0 left-0"></div>
